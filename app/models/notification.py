...
class Notification(db.Model):
    ...
    file = db.relationship('File', backref=db.backref('notications', lazy='dynamic', cascade='all, delete-orphan'))
    creator = db.relationship('User', backref=db.backref('notifications', lazy='dynamic'))
